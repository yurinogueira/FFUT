package br.com.eterniaserver.bddia.domain.user.rest;

import br.com.eterniaserver.bddia.Constants;
import br.com.eterniaserver.bddia.domain.user.entities.UserAccount;
import br.com.eterniaserver.bddia.domain.user.models.AuthenticateRequest;
import br.com.eterniaserver.bddia.domain.user.models.AuthenticateResponse;
import br.com.eterniaserver.bddia.domain.user.models.VerifyTokenRequest;
import br.com.eterniaserver.bddia.domain.user.models.VerifyTokenResponse;
import br.com.eterniaserver.bddia.domain.user.repositories.UserAccountRepository;
import br.com.eterniaserver.bddia.domain.user.services.JWTService;
